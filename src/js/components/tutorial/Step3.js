...
function Step3() {
    return (
        <>
            ...
            <p><em>The Bookworm</em> is a <strong>static web application</strong>, which means it does not interact with a database to collect your data. There are many popular services to host such applications freely. <em>The Bookworm</em> uses <a href="https://firebase.google.com/" target="_blank" rel="noreferrer">Firebase <ExternalLinkIcon size="small" /></a>, a service offered by Google. This also has the advantage that your data is yours. The application only runs locally on your device.</p>
